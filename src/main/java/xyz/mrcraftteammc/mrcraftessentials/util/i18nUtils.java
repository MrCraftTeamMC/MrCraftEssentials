...
public abstract class i18nUtils {
    public static Text getI18nContent(String key) {
        return Text.translatable(key);
    }

    public static Text getI18nContent(String key, Object... objects) {
        return Text.translatable(key, objects);
    }

    public static Text getLiteralContent(String str) {
